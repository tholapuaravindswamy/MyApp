...
const IncidentReportedTo = ({ navigation, route }) => {
  ...
  const handleShowSelected = () => {
    // Filter to show only selected employees
    if (filteredEmployees.length === selectedEmployees.length) {
      // If already showing only selected, show all
      setFilteredEmployees(allEmployees);
    } else {
      // Show only selected
...
export default IncidentReportedTo;