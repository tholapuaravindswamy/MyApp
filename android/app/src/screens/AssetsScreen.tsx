...
type AssetsScreenProps = {
  navigation: DrawerNavigationProp<RootStackParamList, 'Assets'>;
};
...
const AssetsScreen: React.FC<AssetsScreenProps> = ({ navigation }) => {
  ...
  const HandleAdd = () => navigation.navigate('NewScreen');
      ...
      <View style={styles.listItemContent}>
        ...
        <View style={styles.itemDetails}>
          ...
          <Text style={styles.scheduleText}>
            Schedule: 01-04-2025 16:47 | Timer: -02:46
          </Text>
        </View>
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.tabsContainer}>
        {['Guests', 'Internal', 'Assets'].map(tab => (
          <TouchableOpacity
            key={tab}
