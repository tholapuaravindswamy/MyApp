...
const IncidentCategoryModal: React.FC<IncidentCategoryModalProps> = ({ visible, onClose, onSelect }) => {
  ...
  // Update allToggleActive when all items are selected or deselected manually
   useEffect(() => {
