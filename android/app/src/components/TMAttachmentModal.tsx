...
import { View, Text, StyleSheet, TouchableOpacity, SafeAreaView, StatusBar, FlatList, Alert } from "react-native"
...
interface TMAttachmentModalProps {
  visible: boolean
  onClose: () => void
...
const TMAttachmentModal: React.FC<TMAttachmentModalProps> = ({
  visible,
  onClose,
  onSubmit,
  initialAttachments = [],
...
export default TMAttachmentModal
