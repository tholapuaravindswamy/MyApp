...
interface IncidentAttachmentModalProps {
  visible: boolean
  onClose: () => void
  onSave: (attachments: any[]) => void
}

const IncidentAttachmentModal: React.FC<IncidentAttachmentModalProps> = ({ visible, onClose, onSave }) => {
  ...
  const renderAttachmentItem = ({ item }: { item: any }) => (
...
export default IncidentAttachmentModal
