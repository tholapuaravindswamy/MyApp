...
interface ResolutionTypeModalProps {
  visible: boolean
  onClose: () => void
  onSelect: (value: string) => void
}

const ResolutionTypeModal: React.FC<ResolutionTypeModalProps> = ({ visible, onClose, onSelect }) => {
  ...
  const options = [
    { id: "1", name: "Resolution 1" },
    { id: "2", name: "Resolution 2" },
    { id: "3", name: "Resolution 3" },
    { id: "4", name: "Resolution 4" },
    { id: "5", name: "Resolution 5" },
    { id: "6", name: "Resolution 6" },
    { id: "7", name: "Resolution 7" },
    { id: "8", name: "Resolution 8" },
    { id: "9", name: "Resolution 9" },
  ]
    ...
    <AnimatedModal visible={visible} onClose={onClose} adaptiveHeight={true} minHeight={modalHeight}>
      <SafeAreaView style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>Resolution Type</Text>
        </View>
...
export default ResolutionTypeModal
