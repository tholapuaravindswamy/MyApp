...
interface TMAssignToModalProps {
  visible: boolean
  onClose: () => void
...
const TMAssignToModal: React.FC<TMAssignToModalProps> = ({ visible, onClose, onSelect, initialValue = [] }) => {
        ...
        <View style={styles.header}>
          <View style={styles.headerLeft}>
            ...
            <TouchableOpacity onPress={toggleShowSelected} disabled={selectedItems.length === 0}>
              <Text style={[styles.showSelectedText, { color: selectedItems.length === 0 ? "#aaa" : "#007AFF" }]}>
        ...
        {/* Submit Button */}
          ...
          >
            <Text style={styles.submitButtonText}>
              Submit {/*If you want how many slected that count then remove this line and below line uncomment it.*}
...
export default TMAssignToModal
