...
import { View, Text, StyleSheet, TouchableOpacity, SafeAreaView, StatusBar, TextInput, Platform } from "react-native"
...
const TMDescriptionModal: React.FC<TMDescriptionModalProps> = ({
  visible,
  onClose,
  onSubmit,
  initialDescription = "",
