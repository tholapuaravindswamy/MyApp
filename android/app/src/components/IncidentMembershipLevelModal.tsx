...
interface IncidentMembershipLevelModalProps {
  visible: boolean
  onClose: () => void
...
const IncidentMembershipLevelModal: React.FC<IncidentMembershipLevelModalProps> = ({ visible, onClose, onSelect }) => {
...
export default IncidentMembershipLevelModal
