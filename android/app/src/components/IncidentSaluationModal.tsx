...
interface IncidentSalutionModalProps {
  visible: boolean
  onClose: () => void
...
const IncidentSalutionModal: React.FC<IncidentSalutionModalProps> = ({ visible, onClose, onSelect }) => {
      ...
      <View style={styles.container}>
        ...
        <View style={styles.header}>
          <View style={styles.headerLeft}>
            ...
            <Text style={styles.headerTitle}>Saluation</Text>
...
export default IncidentSalutionModal
